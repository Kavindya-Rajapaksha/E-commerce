...
import { AccountBox, Add, Bolt, Category, Dashboard, Home, LocalMall, LocalOffer, Logout } from '@mui/icons-material';
...
const menu = [
    ...
    },
    {
      ...
      icon: <Bolt className="text-primary-color" />,
      activeIcon: <Bolt className="text-white" />,
    },
    {
    ...
    },
    {
      name: "Deals",
      path: "/admin/deals",
      icon: <LocalMall className="text-primary-color" />,
      activeIcon: <LocalMall className="text-white" />,
    },
  ];
